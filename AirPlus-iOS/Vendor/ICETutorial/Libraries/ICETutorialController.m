...
@property (nonatomic, strong, readonly) FUIButton *leftButton;
@property (nonatomic, strong, readonly) FUIButton *rightButton;
...
- (instancetype)initWithPages:(NSArray *)pages {
    ...
    if (self) {
        ...
        _leftButton = [[FUIButton alloc] init];
        _rightButton = [[FUIButton alloc] init];
    }
    return self;
}
...
- (void)setupView {
    ...
    [self.overlayTitle setFont:[UIFont flatFontOfSize:32]];
...
- (void)addAllConstraints {
    ...
    [constraints addObject:@"V:[_leftButton(==40)]-20-|"];
    [constraints addObject:@"V:[_rightButton(==40)]-20-|"];
